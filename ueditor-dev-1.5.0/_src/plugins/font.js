...
UE.plugins['font'] = function () {
    ...
    me.setOpt({
        ...
        'fontsize': [10, 11, 12, 14, 16, 18, 20, 24, 36,48,72,128]
    });
...
//call this do...
    for (var p in fonts) {//key value
        (function (cmd, style) {
            UE.commands[cmd] = {//add a command to  UE (UE [functionname] = UE.functionname)
